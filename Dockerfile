...
RUN apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv E1DD270288B4E6030699E45FA1715D88E1DF1F24 \
 ...
 && apt-get update \
 && apt-get install -y wget supervisor logrotate locales curl \
      nginx openssh-server mysql-client redis-tools \
      git-core ruby2.1 python2.7 python-docutils nodejs \
      libmysqlclient18 libpq5 zlib1g libyaml-0-2 libssl1.0.0 \
      libgdbm3 libreadline6 libncurses5 libffi6 \
      libxml2 libxslt1.1 libcurl3 libicu52 build-essential make \
...
RUN /bin/bash --login -c "${SETUP_DIR}/install.sh"
